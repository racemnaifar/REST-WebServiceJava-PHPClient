    ...
    <main>
        <section id="title_wrapper">
            <div class="container px-3">
				...
				<button style="background:#f34f3f;color:white" class="btn  btn-block btn-flat">TO ORDER</button>
				</form>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <table class="table table-bordered table-light">
                        ...
                        <tbody>
						<?php
						$arr = $_SESSION['list']->getAll();
						foreach ( $arr as $key => $value )
						{
							$url = "http://localhost:8080/FleuristeApp/webresources/fleur/GetByCode?code=".$key;
							$ch = curl_init($url);
						...
						?>
						<tr>
						<td><?php echo $fleur['lib'] ?></td>
						<td><?php echo $fleur['categorie'] ?></td>
						<td><?php echo $fleur['couleur'] ?></td>
